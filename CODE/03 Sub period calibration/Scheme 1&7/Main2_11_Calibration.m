...
%---Evaluation     
    nse  = NSE(Qobs(hymod.date.ID_cali{12}),Qsim(hymod.date.ID_cali{12}));
    lnse = LNSE(Qobs(hymod.date.ID_cali{12}),Qsim(hymod.date.ID_cali{12}));    
...
save(fullfile(folder_name, 'hymod11.mat'), 'hymod');
save(fullfile(folder_name, 'SCEUA11.mat'), 'SCEUA');