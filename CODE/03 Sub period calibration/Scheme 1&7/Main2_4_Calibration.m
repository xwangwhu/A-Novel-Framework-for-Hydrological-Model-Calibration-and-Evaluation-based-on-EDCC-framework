...
%---Evaluation     
    nse  = NSE(Qobs(hymod.date.ID_cali{5}),Qsim(hymod.date.ID_cali{5}));
    lnse = LNSE(Qobs(hymod.date.ID_cali{5}),Qsim(hymod.date.ID_cali{5}));    
...
save(fullfile(folder_name, 'hymod4.mat'), 'hymod');
save(fullfile(folder_name, 'SCEUA4.mat'), 'SCEUA');