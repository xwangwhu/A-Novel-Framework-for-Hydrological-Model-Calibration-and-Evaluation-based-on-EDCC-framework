...
%---Evaluation     
    nse  = NSE(Qobs(hymod.date.ID_cali{8}),Qsim(hymod.date.ID_cali{8}));
    lnse = LNSE(Qobs(hymod.date.ID_cali{8}),Qsim(hymod.date.ID_cali{8}));    
...
save(fullfile(folder_name, 'hymod7.mat'), 'hymod');
save(fullfile(folder_name, 'SCEUA7.mat'), 'SCEUA');