function [snew,fnew,icall,Parameters,Functions]=cceua(s,sf,bl,bu,icall,maxn,Parameters,Functions)
...
fnew = functn(snew);
icall = icall + 1;
Parameters=[Parameters;snew];
Functions=[Functions;fnew];
% Reflection failed; now attempt a contraction point:
if fnew > fw
    snew = sw + beta*(ce-sw);
    fnew = functn(snew);
    icall = icall + 1;
    Parameters=[Parameters;snew];Functions=[Functions;fnew];
