...
%---hymod_parameters
    ...
    hymod.parameters.DDF=parameters(6);      % Degree day factor                               - Range [ 0, 2]
    hymod.parameters.Tth=parameters(7);      % Temperature threshold                           - Range [-5, 5]
    hymod.parameters.Tb=parameters(8);       % Base temperature to calculate melt              - Range [-5, 5]
