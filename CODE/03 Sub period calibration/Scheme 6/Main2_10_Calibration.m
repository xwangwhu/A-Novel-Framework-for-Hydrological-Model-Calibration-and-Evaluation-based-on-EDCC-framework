...
%---Evaluation     
    nse  = NSE(Qobs(hymod.date.ID_cali{11}),Qsim(hymod.date.ID_cali{11}));
    lnse = LNSE(Qobs(hymod.date.ID_cali{11}),Qsim(hymod.date.ID_cali{11}));    
...
save(fullfile(folder_name, 'hymod10.mat'), 'hymod');
save(fullfile(folder_name, 'SCEUA10.mat'), 'SCEUA');