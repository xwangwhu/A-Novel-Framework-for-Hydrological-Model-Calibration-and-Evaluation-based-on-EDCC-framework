...
%---Evaluation     
    nse  = NSE(Qobs(hymod.date.ID_cali{2}),Qsim(hymod.date.ID_cali{2}));
    lnse = LNSE(Qobs(hymod.date.ID_cali{2}),Qsim(hymod.date.ID_cali{2}));    
...
save(fullfile(folder_name, 'hymod1.mat'), 'hymod');
save(fullfile(folder_name, 'SCEUA1.mat'), 'SCEUA');