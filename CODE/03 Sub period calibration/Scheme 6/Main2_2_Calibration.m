...
%---Evaluation     
    nse  = NSE(Qobs(hymod.date.ID_cali{3}),Qsim(hymod.date.ID_cali{3}));
    lnse = LNSE(Qobs(hymod.date.ID_cali{3}),Qsim(hymod.date.ID_cali{3}));    
...
save(fullfile(folder_name, 'hymod2.mat'), 'hymod');
save(fullfile(folder_name, 'SCEUA2.mat'), 'SCEUA');