...
%---Evaluation     
    nse  = NSE(Qobs(hymod.date.ID_cali{4}),Qsim(hymod.date.ID_cali{4}));
    lnse = LNSE(Qobs(hymod.date.ID_cali{4}),Qsim(hymod.date.ID_cali{4}));    
...
save(fullfile(folder_name, 'hymod3.mat'), 'hymod');
save(fullfile(folder_name, 'SCEUA3.mat'), 'SCEUA');