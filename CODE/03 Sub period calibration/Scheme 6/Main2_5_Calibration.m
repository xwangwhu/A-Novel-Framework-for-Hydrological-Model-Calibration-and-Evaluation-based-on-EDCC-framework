...
%---Evaluation     
    nse  = NSE(Qobs(hymod.date.ID_cali{6}),Qsim(hymod.date.ID_cali{6}));
    lnse = LNSE(Qobs(hymod.date.ID_cali{6}),Qsim(hymod.date.ID_cali{6}));    
...
save(fullfile(folder_name, 'hymod5.mat'), 'hymod');
save(fullfile(folder_name, 'SCEUA5.mat'), 'SCEUA');