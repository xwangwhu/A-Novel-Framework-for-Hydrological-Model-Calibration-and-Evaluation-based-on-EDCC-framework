...
%---Evaluation     
    nse  = NSE(Qobs(hymod.date.ID_cali{7}),Qsim(hymod.date.ID_cali{7}));
    lnse = LNSE(Qobs(hymod.date.ID_cali{7}),Qsim(hymod.date.ID_cali{7}));    
...
save(fullfile(folder_name, 'hymod6.mat'), 'hymod');
save(fullfile(folder_name, 'SCEUA6.mat'), 'SCEUA');