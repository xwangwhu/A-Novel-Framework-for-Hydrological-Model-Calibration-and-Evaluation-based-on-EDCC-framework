...
%---Evaluation     
    nse  = NSE(Qobs(hymod.date.ID_cali{9}),Qsim(hymod.date.ID_cali{9}));
    lnse = LNSE(Qobs(hymod.date.ID_cali{9}),Qsim(hymod.date.ID_cali{9}));    
...
save(fullfile(folder_name, 'hymod8.mat'), 'hymod');
save(fullfile(folder_name, 'SCEUA8.mat'), 'SCEUA');