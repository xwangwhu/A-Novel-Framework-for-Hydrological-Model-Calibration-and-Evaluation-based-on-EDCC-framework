...
%---Evaluation     
    nse  = NSE(Qobs(hymod.date.ID_cali{10}),Qsim(hymod.date.ID_cali{10}));
    lnse = LNSE(Qobs(hymod.date.ID_cali{10}),Qsim(hymod.date.ID_cali{10}));    
...
save(fullfile(folder_name, 'hymod9.mat'), 'hymod');
save(fullfile(folder_name, 'SCEUA9.mat'), 'SCEUA');